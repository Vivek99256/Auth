    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link href="favourite" :active="request()->routeIs('user.favourite')">
                    {{ __('Favourite') }} 
                </x-nav-link>  
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <!-- Admin  links-->
                @if (Auth::user()->usertype == 'admin')
                <x-responsive-nav-link href="admin/student" :active="request()->routeIs('admin.student')">
                    {{ __('Student') }} 
                </x-responsive-nav-link>  
                ...
                <x-responsive-nav-link href="favourite" :active="request()->routeIs('user.favourite')">
                    {{ __('Favourite') }} 
                </x-responsive-nav-link>  
